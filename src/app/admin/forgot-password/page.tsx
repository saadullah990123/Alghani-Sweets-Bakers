    ...
    <div className="min-h-screen bg-brand-dark flex items-center justify-center p-4">
      <div className="relative w-full max-w-md bg-white rounded-3xl shadow-2xl p-8 border border-amber-900/40 space-y-6">
        <div className="text-center space-y-3">
          ...
          <div>
            <h1 className="font-serif text-xl font-extrabold text-brand-dark">Reset Admin Password</h1>
        ...
        {sent ? (
          <div className="p-4 bg-green-50 border border-green-200 text-green-800 text-xs font-semibold rounded-xl flex items-start gap-2">
            ...
            <span>
              ...
              (and spam folder), and follow the link within the next hour.
            </span>
          </div>
        ) : (
        ...
        <Link
          href="/admin/login"
          className="flex items-center justify-center gap-1.5 text-xs font-bold text-gray-500 hover:text-brand-600 transition"
        >
